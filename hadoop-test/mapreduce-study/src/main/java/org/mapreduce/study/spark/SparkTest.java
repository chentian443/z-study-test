package org.mapreduce.study.spark;
...
//				.setMaster("local[*]");  //spark应用程序要连接的spark集群的master节点的url，local代表的是本地运行
		conf.setMaster("spark://172.16.10.102:7077");
		
		//创建JavaSparkContext对象
		JavaSparkContext sc = new JavaSparkContext(conf);
		
		//针对输入源（hdfs文件、本地文件等）创建一个初始的RDD   
		JavaRDD<String> lines = sc.textFile("D:/BaiduNetdiskDownload/mapreduce_test/sparkTest/input/test.txt");
		...
		String outputDir = "D:/BaiduNetdiskDownload/mapreduce_test/sparkTest/output";
