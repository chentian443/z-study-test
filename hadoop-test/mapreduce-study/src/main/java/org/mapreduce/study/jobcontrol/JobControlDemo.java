package org.mapreduce.study.jobcontrol;
...
public class JobControlDemo {
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
		...
		String controlPath = "D:\\BaiduNetdiskDownload\\mapreduce_test\\courseMore\\controlDemo";
		...
		FileInputFormat.addInputPath(job1, new Path(controlPath+File.separator+"input"));
		FileOutputFormat.setOutputPath(job1, new Path(controlPath+File.separator+"mid1"));
		...
		FileInputFormat.addInputPath(job2, new Path(controlPath+File.separator+"input"));
		FileOutputFormat.setOutputPath(job2, new Path(controlPath+File.separator+"mid2"));
		...
		FileInputFormat.addInputPath(job3, new Path(controlPath+File.separator+"mid1"));
		FileInputFormat.addInputPath(job3, new Path(controlPath+File.separator+"mid2"));
		FileOutputFormat.setOutputPath(job3, new Path(controlPath+File.separator+"result"));
	...
	public static class MyReducer3 extends Reducer<Text,Text, Text, Text>{
		...
		protected void reduce(Text k4, Iterable<Text> v4s,Reducer<Text, Text, Text, Text>.Context context) 
			...
			context.write(k4, new Text("OK"+"\t"+ temp.substring(0, temp.length() - 1)));
		}
	}
}
