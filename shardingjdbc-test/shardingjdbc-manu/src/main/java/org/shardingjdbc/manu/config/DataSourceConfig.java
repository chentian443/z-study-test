...
import org.shardingjdbc.manu.util.DataSourceUtil;
import org.shardingjdbc.manu.util.GenderShardingAlgorithm;
import org.shardingjdbc.manu.util.IdShardingAlgorithm;
import org.shardingjdbc.manu.util.SnowflakeShardingKeyGenerator;
...
public class DataSourceConfig {
    ...
    public SnowflakeShardingKeyGenerator snowflakeShardingKeyGenerator(){
    	return new SnowflakeShardingKeyGenerator(workId, datacenterId);
    }
    ...
    private TableRuleConfiguration userRuleConfig() {
        ...
        tableRuleConfig.setKeyGenerator(snowflakeShardingKeyGenerator());
