...
import org.websocket.demo.bean.Message;
import org.websocket.demo.bean.Response;
import org.websocket.demo.service.WebSocketService;
 ...
 *
 */
@CrossOrigin // 用于解决跨域问题，该注解要求springmvc版本在4.2以上
@Controller
@Slf4j
public class WebSocketController {
    ...
    public void handleChat(Principal principal, Message message) {
        ...
        if (principal.getName().equals("admin")) {
            ...
            messagingTemplate.convertAndSendToUser("abel", "/queue/notifications", 
